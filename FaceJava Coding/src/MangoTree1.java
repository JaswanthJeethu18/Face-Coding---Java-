...
She plants trees in a rectangular fashion with the order of rows and columns and numbered
 the trees in row-wise order. She planted the mango tree only in a 1st row, 1st column and last column. 
...
public class MangoTree1 {
	...
	public static void main(String[] args) {
		...
		int c = sc.nextInt();
		if (c == 10 || c == 11 || c == 16 || c == 17 || c == 18 || c == 19 || c == 20 || c == 5 || c == 4 || c == 2
				|| c == 3)
